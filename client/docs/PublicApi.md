...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    comment_data = openapi_client.CommentData() # CommentData | 
...
> DeleteCommentPublic200Response delete_comment_public(tenant_id, comment_id, broadcast_id, edit_key=edit_key)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_comment_public(tenant_id, comment_id, broadcast_id, edit_key=edit_key)
...
> GetCommentVoteUserNames200Response get_comment_vote_user_names(tenant_id, comment_id, direction, sso=sso)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_comment_vote_user_names(tenant_id, comment_id, direction, sso=sso)
...
> GetFeedPosts200Response get_feed_posts_public(tenant_id, after_id=after_id, limit=limit, tags=tags)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_feed_posts_public(tenant_id, after_id=after_id, limit=limit, tags=tags)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PublicApi(api_client)
    tenant_id = 'tenant_id_example' # str | 
    page_size = 3.4 # float | Defaults to 20. (optional)
    after_id = 'after_id_example' # str |  (optional)
    include_context = True # bool |  (optional)
    after_created_at = 3.4 # float |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    comment_id = 'comment_id_example' # str | 
    broadcast_id = 'broadcast_id_example' # str | 
    comment_text_update_request = openapi_client.CommentTextUpdateRequest() # CommentTextUpdateRequest | 
    edit_key = 'edit_key_example' # str |  (optional)
    sso = 'sso_example' # str |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    url_id = 'url_id_example' # str | 
    broadcast_id = 'broadcast_id_example' # str | 
    vote_body_params = openapi_client.VoteBodyParams() # VoteBodyParams | 
    session_id = 'session_id_example' # str |  (optional)
    sso = 'sso_example' # str |  (optional)
