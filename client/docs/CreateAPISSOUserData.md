...
json = "{}"
# create an instance of CreateAPISSOUserData from a JSON string
create_apisso_user_data_instance = CreateAPISSOUserData.from_json(json)
# print the JSON string representation of the object
print(CreateAPISSOUserData.to_json())

# convert the object into a dict
create_apisso_user_data_dict = create_apisso_user_data_instance.to_dict()
# create an instance of CreateAPISSOUserData from a dict
create_apisso_user_data_from_dict = CreateAPISSOUserData.from_dict(create_apisso_user_data_dict)
```
