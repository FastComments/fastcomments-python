...
api_comment_base_instance = APICommentBase.from_json(json)
# print the JSON string representation of the object
print(APICommentBase.to_json())

# convert the object into a dict
api_comment_base_dict = api_comment_base_instance.to_dict()
# create an instance of APICommentBase from a dict
api_comment_base_from_dict = APICommentBase.from_dict(api_comment_base_dict)
```
