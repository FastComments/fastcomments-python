...
class TestGetCommentVoteUserNamesResponse(unittest.TestCase):
    """GetCommentVoteUserNamesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommentVoteUserNamesResponse:
        """Test GetCommentVoteUserNamesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommentVoteUserNamesResponse`
        """
        model = GetCommentVoteUserNamesResponse()
        if include_optional:
    ...
    def testGetCommentVoteUserNamesResponse(self):
        """Test GetCommentVoteUserNamesResponse"""
