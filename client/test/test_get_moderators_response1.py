...
class TestGetModeratorsResponse1(unittest.TestCase):
    """GetModeratorsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetModeratorsResponse1:
        """Test GetModeratorsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetModeratorsResponse1`
        """
        model = GetModeratorsResponse1()
        if include_optional:
    ...
    def testGetModeratorsResponse1(self):
        """Test GetModeratorsResponse1"""
