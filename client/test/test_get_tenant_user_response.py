...
class TestGetTenantUserResponse(unittest.TestCase):
    """GetTenantUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTenantUserResponse:
        """Test GetTenantUserResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTenantUserResponse`
        """
        model = GetTenantUserResponse()
        if include_optional:
    ...
    def testGetTenantUserResponse(self):
        """Test GetTenantUserResponse"""
