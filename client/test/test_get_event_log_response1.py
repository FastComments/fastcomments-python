...
class TestGetEventLogResponse1(unittest.TestCase):
    """GetEventLogResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEventLogResponse1:
        """Test GetEventLogResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEventLogResponse1`
        """
        model = GetEventLogResponse1()
        if include_optional:
    ...
    def testGetEventLogResponse1(self):
        """Test GetEventLogResponse1"""
