...
class TestAPIComment(unittest.TestCase):
    """APIComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> APIComment:
        """Test APIComment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `APIComment`
        """
        model = APIComment()
        if include_optional:
            return APIComment(
