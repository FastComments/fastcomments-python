...
class TestGetFeedPostsResponse1(unittest.TestCase):
    """GetFeedPostsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFeedPostsResponse1:
        """Test GetFeedPostsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFeedPostsResponse1`
        """
        model = GetFeedPostsResponse1()
        if include_optional:
    ...
    def testGetFeedPostsResponse1(self):
        """Test GetFeedPostsResponse1"""
