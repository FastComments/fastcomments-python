...
class TestGetModerationCommentTextResponse(unittest.TestCase):
    """GetModerationCommentTextResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetModerationCommentTextResponse:
        """Test GetModerationCommentTextResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetModerationCommentTextResponse`
        """
        model = GetModerationCommentTextResponse()
        if include_optional:
    ...
    def testGetModerationCommentTextResponse(self):
        """Test GetModerationCommentTextResponse"""
