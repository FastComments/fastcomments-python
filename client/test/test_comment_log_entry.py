...
class TestCommentLogEntry(unittest.TestCase):
    """CommentLogEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentLogEntry:
        """Test CommentLogEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentLogEntry`
        """
        model = CommentLogEntry()
        if include_optional:
