...
class TestGetEmailTemplates200Response(unittest.TestCase):
    """GetEmailTemplates200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEmailTemplates200Response:
        """Test GetEmailTemplates200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEmailTemplates200Response`
        """
        model = GetEmailTemplates200Response()
        if include_optional:
            return GetEmailTemplates200Response(
                status = 'success',
                email_templates = [
                    client.models.custom_email_template.CustomEmailTemplate(
                        _id = '', 
                        tenant_id = '', 
                        email_template_id = '', 
                        display_name = '', 
    ...
    def testGetEmailTemplates200Response(self):
        """Test GetEmailTemplates200Response"""
