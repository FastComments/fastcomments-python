...
class TestUnBlockUserFromCommentResponse(unittest.TestCase):
    """UnBlockUserFromCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnBlockUserFromCommentResponse:
        """Test UnBlockUserFromCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnBlockUserFromCommentResponse`
        """
        model = UnBlockUserFromCommentResponse()
        if include_optional:
    ...
    def testUnBlockUserFromCommentResponse(self):
        """Test UnBlockUserFromCommentResponse"""
