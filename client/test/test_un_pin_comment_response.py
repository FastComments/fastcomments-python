...
class TestUnPinCommentResponse(unittest.TestCase):
    """UnPinCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnPinCommentResponse:
        """Test UnPinCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnPinCommentResponse`
        """
        model = UnPinCommentResponse()
        if include_optional:
    ...
    def testUnPinCommentResponse(self):
        """Test UnPinCommentResponse"""
