...
class TestUpdatableCommentParams(unittest.TestCase):
    """UpdatableCommentParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatableCommentParams:
        """Test UpdatableCommentParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatableCommentParams`
        """
        model = UpdatableCommentParams()
        if include_optional:
    ...
    def testUpdatableCommentParams(self):
        """Test UpdatableCommentParams"""
