...
class TestGetCommentTextResponse1(unittest.TestCase):
    """GetCommentTextResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommentTextResponse1:
        """Test GetCommentTextResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommentTextResponse1`
        """
        model = GetCommentTextResponse1()
        if include_optional:
    ...
    def testGetCommentTextResponse1(self):
        """Test GetCommentTextResponse1"""
