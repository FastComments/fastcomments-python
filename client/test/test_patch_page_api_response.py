...
class TestPatchPageAPIResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PatchPageAPIResponse:
        """Test PatchPageAPIResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchPageAPIResponse`
        """
        model = PatchPageAPIResponse()
        if include_optional:
    ...
    def testPatchPageAPIResponse(self):
        """Test PatchPageAPIResponse"""
