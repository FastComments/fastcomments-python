...
class TestGetSearchPagesResponse(unittest.TestCase):
    """GetSearchPagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSearchPagesResponse:
        """Test GetSearchPagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSearchPagesResponse`
        """
        model = GetSearchPagesResponse()
        if include_optional:
    ...
    def testGetSearchPagesResponse(self):
        """Test GetSearchPagesResponse"""
