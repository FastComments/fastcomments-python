...
class TestPostBanUserFromCommentResponse(unittest.TestCase):
    """PostBanUserFromCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostBanUserFromCommentResponse:
        """Test PostBanUserFromCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostBanUserFromCommentResponse`
        """
        model = PostBanUserFromCommentResponse()
        if include_optional:
    ...
    def testPostBanUserFromCommentResponse(self):
        """Test PostBanUserFromCommentResponse"""
