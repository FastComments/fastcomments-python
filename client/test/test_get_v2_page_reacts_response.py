...
class TestGetV2PageReactsResponse(unittest.TestCase):
    """GetV2PageReactsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetV2PageReactsResponse:
        """Test GetV2PageReactsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetV2PageReactsResponse`
        """
        model = GetV2PageReactsResponse()
        if include_optional:
    ...
    def testGetV2PageReactsResponse(self):
        """Test GetV2PageReactsResponse"""
