...
class TestCheckedCommentsForBlockedResponse(unittest.TestCase):
    """CheckedCommentsForBlockedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckedCommentsForBlockedResponse:
        """Test CheckedCommentsForBlockedResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckedCommentsForBlockedResponse`
        """
        model = CheckedCommentsForBlockedResponse()
        if include_optional:
    ...
    def testCheckedCommentsForBlockedResponse(self):
        """Test CheckedCommentsForBlockedResponse"""
