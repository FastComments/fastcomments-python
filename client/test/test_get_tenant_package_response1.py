...
class TestGetTenantPackageResponse1(unittest.TestCase):
    """GetTenantPackageResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTenantPackageResponse1:
        """Test GetTenantPackageResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTenantPackageResponse1`
        """
        model = GetTenantPackageResponse1()
        if include_optional:
    ...
    def testGetTenantPackageResponse1(self):
        """Test GetTenantPackageResponse1"""
