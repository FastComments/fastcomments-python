...
class TestDeletePendingWebhookEventResponse(unittest.TestCase):
    """DeletePendingWebhookEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeletePendingWebhookEventResponse:
        """Test DeletePendingWebhookEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletePendingWebhookEventResponse`
        """
        model = DeletePendingWebhookEventResponse()
        if include_optional:
    ...
    def testDeletePendingWebhookEventResponse(self):
        """Test DeletePendingWebhookEventResponse"""
