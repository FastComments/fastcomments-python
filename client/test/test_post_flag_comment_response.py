...
class TestPostFlagCommentResponse(unittest.TestCase):
    """PostFlagCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostFlagCommentResponse:
        """Test PostFlagCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostFlagCommentResponse`
        """
        model = PostFlagCommentResponse()
        if include_optional:
    ...
    def testPostFlagCommentResponse(self):
        """Test PostFlagCommentResponse"""
