...
class TestCreateCommentPublicResponse(unittest.TestCase):
    """CreateCommentPublicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCommentPublicResponse:
        """Test CreateCommentPublicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCommentPublicResponse`
        """
        model = CreateCommentPublicResponse()
        if include_optional:
    ...
    def testCreateCommentPublicResponse(self):
        """Test CreateCommentPublicResponse"""
