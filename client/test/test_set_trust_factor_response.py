...
class TestSetTrustFactorResponse(unittest.TestCase):
    """SetTrustFactorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetTrustFactorResponse:
        """Test SetTrustFactorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetTrustFactorResponse`
        """
        model = SetTrustFactorResponse()
        if include_optional:
            return SetTrustFactorResponse(
                previous_manual_trust_factor = 1.337,
                status = 'success',
                reason = '',
                code = '',
                secondary_code = '',
    ...
    def testSetTrustFactorResponse(self):
        """Test SetTrustFactorResponse"""
