...
class TestVoteCommentResponse(unittest.TestCase):
    """VoteCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoteCommentResponse:
        """Test VoteCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoteCommentResponse`
        """
    ...
    def testVoteCommentResponse(self):
        """Test VoteCommentResponse"""
