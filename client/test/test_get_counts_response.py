...
class TestGetCountsResponse(unittest.TestCase):
    """GetCountsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCountsResponse:
        """Test GetCountsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCountsResponse`
        """
        model = GetCountsResponse()
        if include_optional:
    ...
    def testGetCountsResponse(self):
        """Test GetCountsResponse"""
