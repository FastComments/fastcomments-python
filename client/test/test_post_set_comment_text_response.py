...
class TestPostSetCommentTextResponse(unittest.TestCase):
    """PostSetCommentTextResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSetCommentTextResponse:
        """Test PostSetCommentTextResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSetCommentTextResponse`
        """
        model = PostSetCommentTextResponse()
        if include_optional:
    ...
    def testPostSetCommentTextResponse(self):
        """Test PostSetCommentTextResponse"""
