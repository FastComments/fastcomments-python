...
class TestGetCountResponse(unittest.TestCase):
    """GetCountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCountResponse:
        """Test GetCountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCountResponse`
        """
        model = GetCountResponse()
        if include_optional:
