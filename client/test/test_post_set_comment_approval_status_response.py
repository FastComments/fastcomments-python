...
class TestPostSetCommentApprovalStatusResponse(unittest.TestCase):
    """PostSetCommentApprovalStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSetCommentApprovalStatusResponse:
        """Test PostSetCommentApprovalStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSetCommentApprovalStatusResponse`
        """
        model = PostSetCommentApprovalStatusResponse()
        if include_optional:
            return PostSetCommentApprovalStatusResponse(
                did_reset_flagged_count = True,
                status = 'success',
                reason = '',
                code = '',
                secondary_code = '',
    ...
    def testPostSetCommentApprovalStatusResponse(self):
        """Test PostSetCommentApprovalStatusResponse"""
