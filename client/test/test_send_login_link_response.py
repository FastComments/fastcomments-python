...
class TestSendLoginLinkResponse(unittest.TestCase):
    """SendLoginLinkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLoginLinkResponse:
        """Test SendLoginLinkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLoginLinkResponse`
        """
        model = SendLoginLinkResponse()
        if include_optional:
    ...
    def testSendLoginLinkResponse(self):
        """Test SendLoginLinkResponse"""
