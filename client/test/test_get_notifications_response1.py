...
class TestGetNotificationsResponse1(unittest.TestCase):
    """GetNotificationsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNotificationsResponse1:
        """Test GetNotificationsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNotificationsResponse1`
        """
        model = GetNotificationsResponse1()
        if include_optional:
    ...
    def testGetNotificationsResponse1(self):
        """Test GetNotificationsResponse1"""
