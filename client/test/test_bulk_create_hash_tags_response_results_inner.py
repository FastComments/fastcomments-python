...
class TestBulkCreateHashTagsResponseResultsInner(unittest.TestCase):
    """BulkCreateHashTagsResponseResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkCreateHashTagsResponseResultsInner:
        """Test BulkCreateHashTagsResponseResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkCreateHashTagsResponseResultsInner`
        """
        model = BulkCreateHashTagsResponseResultsInner()
        if include_optional:
    ...
    def testBulkCreateHashTagsResponseResultsInner(self):
        """Test BulkCreateHashTagsResponseResultsInner"""
