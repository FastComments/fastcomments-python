...
class TestUnLockCommentResponse(unittest.TestCase):
    """UnLockCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnLockCommentResponse:
        """Test UnLockCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnLockCommentResponse`
        """
        model = UnLockCommentResponse()
        if include_optional:
    ...
    def testUnLockCommentResponse(self):
        """Test UnLockCommentResponse"""
