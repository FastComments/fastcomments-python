...
class TestGetQuestionConfigsResponse1(unittest.TestCase):
    """GetQuestionConfigsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuestionConfigsResponse1:
        """Test GetQuestionConfigsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuestionConfigsResponse1`
        """
        model = GetQuestionConfigsResponse1()
        if include_optional:
    ...
    def testGetQuestionConfigsResponse1(self):
        """Test GetQuestionConfigsResponse1"""
