...
class TestSaveCommentsBulkResponse(unittest.TestCase):
    """SaveCommentsBulkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveCommentsBulkResponse:
        """Test SaveCommentsBulkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveCommentsBulkResponse`
        """
        model = SaveCommentsBulkResponse()
        if include_optional:
    ...
    def testSaveCommentsBulkResponse(self):
        """Test SaveCommentsBulkResponse"""
