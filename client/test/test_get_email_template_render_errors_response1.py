...
class TestGetEmailTemplateRenderErrorsResponse1(unittest.TestCase):
    """GetEmailTemplateRenderErrorsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEmailTemplateRenderErrorsResponse1:
        """Test GetEmailTemplateRenderErrorsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEmailTemplateRenderErrorsResponse1`
        """
        model = GetEmailTemplateRenderErrorsResponse1()
        if include_optional:
            return GetEmailTemplateRenderErrorsResponse1(
                status = 'success',
                render_errors = [
                    client.models.email_template_render_error_response.EmailTemplateRenderErrorResponse(
                        id = '', 
                        tenant_id = '', 
                        custom_template_id = '', 
                        error = '', 
    ...
    def testGetEmailTemplateRenderErrorsResponse1(self):
        """Test GetEmailTemplateRenderErrorsResponse1"""
