...
class TestGetPagesPublicResponse(unittest.TestCase):
    """GetPagesPublicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPagesPublicResponse:
        """Test GetPagesPublicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPagesPublicResponse`
        """
        model = GetPagesPublicResponse()
        if include_optional:
            return GetPagesPublicResponse(
                next_cursor = '',
                pages = [
                    client.models.public_page.PublicPage(
                        updated_at = 56, 
                        comment_count = 56, 
                        title = '', 
                        url = '', 
    ...
    def testGetPagesPublicResponse(self):
        """Test GetPagesPublicResponse"""
