...
class TestCreateFeedPostParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateFeedPostParams:
        """Test CreateFeedPostParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFeedPostParams`
        """
        model = CreateFeedPostParams()
        if include_optional:
    ...
    def testCreateFeedPostParams(self):
        """Test CreateFeedPostParams"""
