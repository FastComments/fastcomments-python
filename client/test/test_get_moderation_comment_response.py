...
class TestGetModerationCommentResponse(unittest.TestCase):
    """GetModerationCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetModerationCommentResponse:
        """Test GetModerationCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetModerationCommentResponse`
        """
        model = GetModerationCommentResponse()
        if include_optional:
            return GetModerationCommentResponse(
                comment = client.models.moderation_api_comment.ModerationAPIComment(
    ...
    def testGetModerationCommentResponse(self):
        """Test GetModerationCommentResponse"""
