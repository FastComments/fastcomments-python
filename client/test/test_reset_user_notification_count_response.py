...
class TestResetUserNotificationCountResponse(unittest.TestCase):
    """ResetUserNotificationCountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResetUserNotificationCountResponse:
        """Test ResetUserNotificationCountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResetUserNotificationCountResponse`
        """
        model = ResetUserNotificationCountResponse()
        if include_optional:
    ...
    def testResetUserNotificationCountResponse(self):
        """Test ResetUserNotificationCountResponse"""
