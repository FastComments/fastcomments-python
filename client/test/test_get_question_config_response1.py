...
class TestGetQuestionConfigResponse1(unittest.TestCase):
    """GetQuestionConfigResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuestionConfigResponse1:
        """Test GetQuestionConfigResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuestionConfigResponse1`
        """
        model = GetQuestionConfigResponse1()
        if include_optional:
    ...
    def testGetQuestionConfigResponse1(self):
        """Test GetQuestionConfigResponse1"""
