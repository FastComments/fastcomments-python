...
class TestGetApiExportStatusResponse(unittest.TestCase):
    """GetApiExportStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApiExportStatusResponse:
        """Test GetApiExportStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApiExportStatusResponse`
        """
        model = GetApiExportStatusResponse()
        if include_optional:
    ...
    def testGetApiExportStatusResponse(self):
        """Test GetApiExportStatusResponse"""
