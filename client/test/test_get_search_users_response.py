...
class TestGetSearchUsersResponse(unittest.TestCase):
    """GetSearchUsersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSearchUsersResponse:
        """Test GetSearchUsersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSearchUsersResponse`
        """
        model = GetSearchUsersResponse()
        if include_optional:
    ...
    def testGetSearchUsersResponse(self):
        """Test GetSearchUsersResponse"""
