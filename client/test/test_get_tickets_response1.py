...
class TestGetTicketsResponse1(unittest.TestCase):
    """GetTicketsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTicketsResponse1:
        """Test GetTicketsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTicketsResponse1`
        """
        model = GetTicketsResponse1()
        if include_optional:
    ...
    def testGetTicketsResponse1(self):
        """Test GetTicketsResponse1"""
