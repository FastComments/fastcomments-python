...
class TestPostSetCommentSpamStatusResponse(unittest.TestCase):
    """PostSetCommentSpamStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSetCommentSpamStatusResponse:
        """Test PostSetCommentSpamStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSetCommentSpamStatusResponse`
        """
        model = PostSetCommentSpamStatusResponse()
        if include_optional:
    ...
    def testPostSetCommentSpamStatusResponse(self):
        """Test PostSetCommentSpamStatusResponse"""
