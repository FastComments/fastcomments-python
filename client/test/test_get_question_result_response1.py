...
class TestGetQuestionResultResponse1(unittest.TestCase):
    """GetQuestionResultResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuestionResultResponse1:
        """Test GetQuestionResultResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuestionResultResponse1`
        """
        model = GetQuestionResultResponse1()
        if include_optional:
    ...
    def testGetQuestionResultResponse1(self):
        """Test GetQuestionResultResponse1"""
