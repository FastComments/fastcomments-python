...
class TestCreateV2PageReactResponse(unittest.TestCase):
    """CreateV2PageReactResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateV2PageReactResponse:
        """Test CreateV2PageReactResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateV2PageReactResponse`
        """
        model = CreateV2PageReactResponse()
        if include_optional:
    ...
    def testCreateV2PageReactResponse(self):
        """Test CreateV2PageReactResponse"""
