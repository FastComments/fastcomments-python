...
class TestGetVotesResponse1(unittest.TestCase):
    """GetVotesResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVotesResponse1:
        """Test GetVotesResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVotesResponse1`
        """
        model = GetVotesResponse1()
        if include_optional:
    ...
    def testGetVotesResponse1(self):
        """Test GetVotesResponse1"""
