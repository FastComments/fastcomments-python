...
class TestGetPublicFeedPostsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPublicFeedPostsResponse:
        """Test GetPublicFeedPostsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPublicFeedPostsResponse`
        """
        model = GetPublicFeedPostsResponse()
        if include_optional:
    ...
    def testGetPublicFeedPostsResponse(self):
        """Test GetPublicFeedPostsResponse"""
