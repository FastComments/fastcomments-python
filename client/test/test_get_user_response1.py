...
class TestGetUserResponse1(unittest.TestCase):
    """GetUserResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserResponse1:
        """Test GetUserResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserResponse1`
        """
        model = GetUserResponse1()
        if include_optional:
            return GetUserResponse1(
                status = 'success',
                user = client.models.user.User(
                    _id = '', 
                    tenant_id = '', 
                    username = '', 
                    display_name = '', 
