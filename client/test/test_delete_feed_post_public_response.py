...
class TestDeleteFeedPostPublicResponse(unittest.TestCase):
    """DeleteFeedPostPublicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteFeedPostPublicResponse:
        """Test DeleteFeedPostPublicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteFeedPostPublicResponse`
        """
        model = DeleteFeedPostPublicResponse()
        if include_optional:
    ...
    def testDeleteFeedPostPublicResponse(self):
        """Test DeleteFeedPostPublicResponse"""
