...
class TestDeleteTenantPackageResponse(unittest.TestCase):
    """DeleteTenantPackageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteTenantPackageResponse:
        """Test DeleteTenantPackageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteTenantPackageResponse`
        """
        model = DeleteTenantPackageResponse()
        if include_optional:
    ...
    def testDeleteTenantPackageResponse(self):
        """Test DeleteTenantPackageResponse"""
