...
class TestAddHashTagResponse(unittest.TestCase):
    """AddHashTagResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddHashTagResponse:
        """Test AddHashTagResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddHashTagResponse`
        """
        model = AddHashTagResponse()
        if include_optional:
    ...
    def testAddHashTagResponse(self):
        """Test AddHashTagResponse"""
