...
class TestUpdateTenantPackageResponse(unittest.TestCase):
    """UpdateTenantPackageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTenantPackageResponse:
        """Test UpdateTenantPackageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTenantPackageResponse`
        """
        model = UpdateTenantPackageResponse()
        if include_optional:
    ...
    def testUpdateTenantPackageResponse(self):
        """Test UpdateTenantPackageResponse"""
