...
class TestSetCommentTextResponse1(unittest.TestCase):
    """SetCommentTextResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetCommentTextResponse1:
        """Test SetCommentTextResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetCommentTextResponse1`
        """
        model = SetCommentTextResponse1()
        if include_optional:
    ...
    def testSetCommentTextResponse1(self):
        """Test SetCommentTextResponse1"""
