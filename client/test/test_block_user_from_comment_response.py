...
class TestBlockUserFromCommentResponse(unittest.TestCase):
    """BlockUserFromCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlockUserFromCommentResponse:
        """Test BlockUserFromCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlockUserFromCommentResponse`
        """
        model = BlockUserFromCommentResponse()
        if include_optional:
    ...
    def testBlockUserFromCommentResponse(self):
        """Test BlockUserFromCommentResponse"""
