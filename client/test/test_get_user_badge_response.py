...
class TestGetUserBadgeResponse(unittest.TestCase):
    """GetUserBadgeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserBadgeResponse:
        """Test GetUserBadgeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserBadgeResponse`
        """
        model = GetUserBadgeResponse()
        if include_optional:
    ...
    def testGetUserBadgeResponse(self):
        """Test GetUserBadgeResponse"""
