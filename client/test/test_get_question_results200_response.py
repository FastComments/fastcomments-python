...
class TestGetQuestionResults200Response(unittest.TestCase):
    """GetQuestionResults200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuestionResults200Response:
        """Test GetQuestionResults200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuestionResults200Response`
        """
        model = GetQuestionResults200Response()
        if include_optional:
            return GetQuestionResults200Response(
                status = 'success',
                question_results = [
                    client.models.question_result.QuestionResult(
                        _id = '', 
                        tenant_id = '', 
                        url_id = '', 
                        anon_user_id = '', 
    ...
    def testGetQuestionResults200Response(self):
        """Test GetQuestionResults200Response"""
