...
class TestGetTenantUsersResponse1(unittest.TestCase):
    """GetTenantUsersResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTenantUsersResponse1:
        """Test GetTenantUsersResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTenantUsersResponse1`
        """
        model = GetTenantUsersResponse1()
        if include_optional:
            return GetTenantUsersResponse1(
                status = 'success',
                tenant_users = [
                    client.models.user.User(
                        _id = '', 
                        tenant_id = '', 
                        username = '', 
                        display_name = '', 
    ...
    def testGetTenantUsersResponse1(self):
        """Test GetTenantUsersResponse1"""
