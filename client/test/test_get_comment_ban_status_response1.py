...
class TestGetCommentBanStatusResponse1(unittest.TestCase):
    """GetCommentBanStatusResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommentBanStatusResponse1:
        """Test GetCommentBanStatusResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommentBanStatusResponse1`
        """
        model = GetCommentBanStatusResponse1()
        if include_optional:
    ...
    def testGetCommentBanStatusResponse1(self):
        """Test GetCommentBanStatusResponse1"""
