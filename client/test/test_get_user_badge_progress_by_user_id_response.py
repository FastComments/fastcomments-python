...
class TestGetUserBadgeProgressByUserIdResponse(unittest.TestCase):
    """GetUserBadgeProgressByUserIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserBadgeProgressByUserIdResponse:
        """Test GetUserBadgeProgressByUserIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserBadgeProgressByUserIdResponse`
        """
        model = GetUserBadgeProgressByUserIdResponse()
        if include_optional:
            return GetUserBadgeProgressByUserIdResponse(
                status = 'success',
                user_badge_progress = client.models.user_badge_progress.UserBadgeProgress(
                    _id = '', 
                    tenant_id = '', 
                    user_id = '', 
                    first_comment_id = '', 
    ...
    def testGetUserBadgeProgressByUserIdResponse(self):
        """Test GetUserBadgeProgressByUserIdResponse"""
