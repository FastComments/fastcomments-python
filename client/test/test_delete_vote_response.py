...
class TestDeleteVoteResponse(unittest.TestCase):
    """DeleteVoteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteVoteResponse:
        """Test DeleteVoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteVoteResponse`
        """
    ...
    def testDeleteVoteResponse(self):
        """Test DeleteVoteResponse"""
