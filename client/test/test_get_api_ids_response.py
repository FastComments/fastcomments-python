...
class TestGetApiIdsResponse(unittest.TestCase):
    """GetApiIdsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApiIdsResponse:
        """Test GetApiIdsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApiIdsResponse`
        """
        model = GetApiIdsResponse()
        if include_optional:
    ...
    def testGetApiIdsResponse(self):
        """Test GetApiIdsResponse"""
