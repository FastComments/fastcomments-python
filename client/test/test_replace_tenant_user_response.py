...
class TestReplaceTenantUserResponse(unittest.TestCase):
    """ReplaceTenantUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplaceTenantUserResponse:
        """Test ReplaceTenantUserResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplaceTenantUserResponse`
        """
        model = ReplaceTenantUserResponse()
        if include_optional:
    ...
    def testReplaceTenantUserResponse(self):
        """Test ReplaceTenantUserResponse"""
