...
class TestSendInviteResponse(unittest.TestCase):
    """SendInviteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendInviteResponse:
        """Test SendInviteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInviteResponse`
        """
        model = SendInviteResponse()
        if include_optional:
    ...
    def testSendInviteResponse(self):
        """Test SendInviteResponse"""
