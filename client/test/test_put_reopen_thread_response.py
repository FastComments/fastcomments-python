...
class TestPutReopenThreadResponse(unittest.TestCase):
    """PutReopenThreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutReopenThreadResponse:
        """Test PutReopenThreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutReopenThreadResponse`
        """
        model = PutReopenThreadResponse()
        if include_optional:
    ...
    def testPutReopenThreadResponse(self):
        """Test PutReopenThreadResponse"""
