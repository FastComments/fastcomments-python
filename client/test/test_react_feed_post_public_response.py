...
class TestReactFeedPostPublicResponse(unittest.TestCase):
    """ReactFeedPostPublicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReactFeedPostPublicResponse:
        """Test ReactFeedPostPublicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReactFeedPostPublicResponse`
        """
        model = ReactFeedPostPublicResponse()
        if include_optional:
    ...
    def testReactFeedPostPublicResponse(self):
        """Test ReactFeedPostPublicResponse"""
