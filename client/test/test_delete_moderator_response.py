...
class TestDeleteModeratorResponse(unittest.TestCase):
    """DeleteModeratorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteModeratorResponse:
        """Test DeleteModeratorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteModeratorResponse`
        """
        model = DeleteModeratorResponse()
        if include_optional:
    ...
    def testDeleteModeratorResponse(self):
        """Test DeleteModeratorResponse"""
