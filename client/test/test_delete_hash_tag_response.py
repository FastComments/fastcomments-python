...
class TestDeleteHashTagResponse(unittest.TestCase):
    """DeleteHashTagResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteHashTagResponse:
        """Test DeleteHashTagResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteHashTagResponse`
        """
        model = DeleteHashTagResponse()
        if include_optional:
    ...
    def testDeleteHashTagResponse(self):
        """Test DeleteHashTagResponse"""
