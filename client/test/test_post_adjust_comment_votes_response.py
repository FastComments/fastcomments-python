...
class TestPostAdjustCommentVotesResponse(unittest.TestCase):
    """PostAdjustCommentVotesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAdjustCommentVotesResponse:
        """Test PostAdjustCommentVotesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAdjustCommentVotesResponse`
        """
        model = PostAdjustCommentVotesResponse()
        if include_optional:
    ...
    def testPostAdjustCommentVotesResponse(self):
        """Test PostAdjustCommentVotesResponse"""
