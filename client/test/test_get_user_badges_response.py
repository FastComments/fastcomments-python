...
class TestGetUserBadgesResponse(unittest.TestCase):
    """GetUserBadgesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserBadgesResponse:
        """Test GetUserBadgesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserBadgesResponse`
        """
        model = GetUserBadgesResponse()
        if include_optional:
    ...
    def testGetUserBadgesResponse(self):
        """Test GetUserBadgesResponse"""
