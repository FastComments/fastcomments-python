...
class TestGetPendingWebhookEventsResponse1(unittest.TestCase):
    """GetPendingWebhookEventsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPendingWebhookEventsResponse1:
        """Test GetPendingWebhookEventsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPendingWebhookEventsResponse1`
        """
        model = GetPendingWebhookEventsResponse1()
        if include_optional:
            return GetPendingWebhookEventsResponse1(
                status = 'success',
                pending_webhook_events = [
                    client.models.pending_comment_to_sync_outbound.PendingCommentToSyncOutbound(
                        _id = '', 
                        comment_id = '', 
                        ...
                        type = 1.337, 
                        domain = '', 
                        last_error = client.models.last_error.lastError(), 
                        webhook_id = '', )
                    ],
                reason = '',
                code = '',
    ...
    def testGetPendingWebhookEventsResponse1(self):
        """Test GetPendingWebhookEventsResponse1"""
