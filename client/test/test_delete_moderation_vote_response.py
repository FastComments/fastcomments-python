...
class TestDeleteModerationVoteResponse(unittest.TestCase):
    """DeleteModerationVoteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteModerationVoteResponse:
        """Test DeleteModerationVoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteModerationVoteResponse`
        """
        model = DeleteModerationVoteResponse()
        if include_optional:
    ...
    def testDeleteModerationVoteResponse(self):
        """Test DeleteModerationVoteResponse"""
