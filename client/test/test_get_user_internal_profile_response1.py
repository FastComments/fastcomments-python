...
class TestGetUserInternalProfileResponse1(unittest.TestCase):
    """GetUserInternalProfileResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserInternalProfileResponse1:
        """Test GetUserInternalProfileResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserInternalProfileResponse1`
        """
        model = GetUserInternalProfileResponse1()
        if include_optional:
            return GetUserInternalProfileResponse1(
                profile = client.models.get_user_internal_profile_response_profile.GetUserInternalProfileResponse_profile(
                    commenter_name = '', 
    ...
    def testGetUserInternalProfileResponse1(self):
        """Test GetUserInternalProfileResponse1"""
