...
class TestGetGifLargeResponse(unittest.TestCase):
    """GetGifLargeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGifLargeResponse:
        """Test GetGifLargeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGifLargeResponse`
        """
        model = GetGifLargeResponse()
        if include_optional:
    ...
    def testGetGifLargeResponse(self):
        """Test GetGifLargeResponse"""
