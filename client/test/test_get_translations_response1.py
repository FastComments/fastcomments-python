...
class TestGetTranslationsResponse1(unittest.TestCase):
    """GetTranslationsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTranslationsResponse1:
        """Test GetTranslationsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTranslationsResponse1`
        """
        model = GetTranslationsResponse1()
        if include_optional:
    ...
    def testGetTranslationsResponse1(self):
        """Test GetTranslationsResponse1"""
