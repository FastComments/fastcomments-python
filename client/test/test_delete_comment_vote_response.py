...
class TestDeleteCommentVoteResponse(unittest.TestCase):
    """DeleteCommentVoteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteCommentVoteResponse:
        """Test DeleteCommentVoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteCommentVoteResponse`
        """
        model = DeleteCommentVoteResponse()
        if include_optional:
    ...
    def testDeleteCommentVoteResponse(self):
        """Test DeleteCommentVoteResponse"""
