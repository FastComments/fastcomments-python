...
class TestGetUserNotificationsResponse(unittest.TestCase):
    """GetUserNotificationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserNotificationsResponse:
        """Test GetUserNotificationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserNotificationsResponse`
        """
        model = GetUserNotificationsResponse()
        if include_optional:
    ...
    def testGetUserNotificationsResponse(self):
        """Test GetUserNotificationsResponse"""
