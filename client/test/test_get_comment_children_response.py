...
class TestGetCommentChildrenResponse(unittest.TestCase):
    """GetCommentChildrenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommentChildrenResponse:
        """Test GetCommentChildrenResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommentChildrenResponse`
        """
        model = GetCommentChildrenResponse()
        if include_optional:
    ...
    def testGetCommentChildrenResponse(self):
        """Test GetCommentChildrenResponse"""
