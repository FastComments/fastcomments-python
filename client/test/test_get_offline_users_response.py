...
class TestGetOfflineUsersResponse(unittest.TestCase):
    """GetOfflineUsersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOfflineUsersResponse:
        """Test GetOfflineUsersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOfflineUsersResponse`
        """
        model = GetOfflineUsersResponse()
        if include_optional:
    ...
    def testGetOfflineUsersResponse(self):
        """Test GetOfflineUsersResponse"""
