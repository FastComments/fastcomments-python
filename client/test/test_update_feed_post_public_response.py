...
class TestUpdateFeedPostPublicResponse(unittest.TestCase):
    """UpdateFeedPostPublicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFeedPostPublicResponse:
        """Test UpdateFeedPostPublicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFeedPostPublicResponse`
        """
        model = UpdateFeedPostPublicResponse()
        if include_optional:
    ...
    def testUpdateFeedPostPublicResponse(self):
        """Test UpdateFeedPostPublicResponse"""
