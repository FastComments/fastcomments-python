...
class TestPutAwardBadgeResponse(unittest.TestCase):
    """PutAwardBadgeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutAwardBadgeResponse:
        """Test PutAwardBadgeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutAwardBadgeResponse`
        """
        model = PutAwardBadgeResponse()
        if include_optional:
    ...
    def testPutAwardBadgeResponse(self):
        """Test PutAwardBadgeResponse"""
