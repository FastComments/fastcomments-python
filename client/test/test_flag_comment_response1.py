...
class TestFlagCommentResponse1(unittest.TestCase):
    """FlagCommentResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlagCommentResponse1:
        """Test FlagCommentResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlagCommentResponse1`
        """
        model = FlagCommentResponse1()
        if include_optional:
    ...
    def testFlagCommentResponse1(self):
        """Test FlagCommentResponse1"""
