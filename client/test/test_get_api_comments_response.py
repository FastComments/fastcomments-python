...
class TestGetApiCommentsResponse(unittest.TestCase):
    """GetApiCommentsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApiCommentsResponse:
        """Test GetApiCommentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApiCommentsResponse`
        """
        model = GetApiCommentsResponse()
        if include_optional:
            return GetApiCommentsResponse(
                status = 'success',
                translations = client.models.translations.translations(),
                comments = [
    ...
    def testGetApiCommentsResponse(self):
        """Test GetApiCommentsResponse"""
