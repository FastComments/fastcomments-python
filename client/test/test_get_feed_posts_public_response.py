...
class TestGetFeedPostsPublicResponse(unittest.TestCase):
    """GetFeedPostsPublicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFeedPostsPublicResponse:
        """Test GetFeedPostsPublicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFeedPostsPublicResponse`
        """
        model = GetFeedPostsPublicResponse()
        if include_optional:
    ...
    def testGetFeedPostsPublicResponse(self):
        """Test GetFeedPostsPublicResponse"""
