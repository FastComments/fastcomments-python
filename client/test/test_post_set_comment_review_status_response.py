...
class TestPostSetCommentReviewStatusResponse(unittest.TestCase):
    """PostSetCommentReviewStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSetCommentReviewStatusResponse:
        """Test PostSetCommentReviewStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSetCommentReviewStatusResponse`
        """
        model = PostSetCommentReviewStatusResponse()
        if include_optional:
    ...
    def testPostSetCommentReviewStatusResponse(self):
        """Test PostSetCommentReviewStatusResponse"""
