...
class TestUnFlagCommentResponse(unittest.TestCase):
    """UnFlagCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnFlagCommentResponse:
        """Test UnFlagCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnFlagCommentResponse`
        """
        model = UnFlagCommentResponse()
        if include_optional:
    ...
    def testUnFlagCommentResponse(self):
        """Test UnFlagCommentResponse"""
