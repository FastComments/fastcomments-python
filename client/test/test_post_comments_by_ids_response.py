...
class TestPostCommentsByIdsResponse(unittest.TestCase):
    """PostCommentsByIdsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostCommentsByIdsResponse:
        """Test PostCommentsByIdsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostCommentsByIdsResponse`
        """
        model = PostCommentsByIdsResponse()
        if include_optional:
    ...
    def testPostCommentsByIdsResponse(self):
        """Test PostCommentsByIdsResponse"""
