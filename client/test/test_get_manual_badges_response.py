...
class TestGetManualBadgesResponse(unittest.TestCase):
    """GetManualBadgesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetManualBadgesResponse:
        """Test GetManualBadgesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetManualBadgesResponse`
        """
        model = GetManualBadgesResponse()
        if include_optional:
    ...
    def testGetManualBadgesResponse(self):
        """Test GetManualBadgesResponse"""
