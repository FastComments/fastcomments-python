...
class TestDeleteCommentPublicResponse(unittest.TestCase):
    """DeleteCommentPublicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteCommentPublicResponse:
        """Test DeleteCommentPublicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteCommentPublicResponse`
        """
        model = DeleteCommentPublicResponse()
        if include_optional:
    ...
    def testDeleteCommentPublicResponse(self):
        """Test DeleteCommentPublicResponse"""
