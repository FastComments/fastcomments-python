...
class TestPostVoteResponse(unittest.TestCase):
    """PostVoteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostVoteResponse:
        """Test PostVoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostVoteResponse`
        """
        model = PostVoteResponse()
        if include_optional:
