...
class TestCreateFeedPostResponse1(unittest.TestCase):
    """CreateFeedPostResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFeedPostResponse1:
        """Test CreateFeedPostResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFeedPostResponse1`
        """
        model = CreateFeedPostResponse1()
        if include_optional:
    ...
    def testCreateFeedPostResponse1(self):
        """Test CreateFeedPostResponse1"""
