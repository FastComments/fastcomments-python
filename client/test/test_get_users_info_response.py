...
class TestGetUsersInfoResponse(unittest.TestCase):
    """GetUsersInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUsersInfoResponse:
        """Test GetUsersInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUsersInfoResponse`
        """
        model = GetUsersInfoResponse()
        if include_optional:
    ...
    def testGetUsersInfoResponse(self):
        """Test GetUsersInfoResponse"""
