...
class TestPostApiExportResponse(unittest.TestCase):
    """PostApiExportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostApiExportResponse:
        """Test PostApiExportResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostApiExportResponse`
        """
        model = PostApiExportResponse()
        if include_optional:
    ...
    def testPostApiExportResponse(self):
        """Test PostApiExportResponse"""
