...
class TestAddHashTagsBulkResponse(unittest.TestCase):
    """AddHashTagsBulkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddHashTagsBulkResponse:
        """Test AddHashTagsBulkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddHashTagsBulkResponse`
        """
        model = AddHashTagsBulkResponse()
        if include_optional:
    ...
    def testAddHashTagsBulkResponse(self):
        """Test AddHashTagsBulkResponse"""
