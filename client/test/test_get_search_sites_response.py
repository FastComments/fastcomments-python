...
class TestGetSearchSitesResponse(unittest.TestCase):
    """GetSearchSitesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSearchSitesResponse:
        """Test GetSearchSitesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSearchSitesResponse`
        """
        model = GetSearchSitesResponse()
        if include_optional:
    ...
    def testGetSearchSitesResponse(self):
        """Test GetSearchSitesResponse"""
