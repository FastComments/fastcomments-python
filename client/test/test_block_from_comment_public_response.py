...
class TestBlockFromCommentPublicResponse(unittest.TestCase):
    """BlockFromCommentPublicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlockFromCommentPublicResponse:
        """Test BlockFromCommentPublicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlockFromCommentPublicResponse`
        """
        model = BlockFromCommentPublicResponse()
        if include_optional:
    ...
    def testBlockFromCommentPublicResponse(self):
        """Test BlockFromCommentPublicResponse"""
