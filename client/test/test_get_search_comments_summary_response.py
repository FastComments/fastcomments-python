...
class TestGetSearchCommentsSummaryResponse(unittest.TestCase):
    """GetSearchCommentsSummaryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSearchCommentsSummaryResponse:
        """Test GetSearchCommentsSummaryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSearchCommentsSummaryResponse`
        """
        model = GetSearchCommentsSummaryResponse()
        if include_optional:
    ...
    def testGetSearchCommentsSummaryResponse(self):
        """Test GetSearchCommentsSummaryResponse"""
