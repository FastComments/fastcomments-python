...
class TestGetFeedPostsStatsResponse(unittest.TestCase):
    """GetFeedPostsStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFeedPostsStatsResponse:
        """Test GetFeedPostsStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFeedPostsStatsResponse`
        """
        model = GetFeedPostsStatsResponse()
        if include_optional:
    ...
    def testGetFeedPostsStatsResponse(self):
        """Test GetFeedPostsStatsResponse"""
