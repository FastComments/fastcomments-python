...
class TestUpdateAPIPageData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateAPIPageData:
        """Test UpdateAPIPageData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAPIPageData`
        """
        model = UpdateAPIPageData()
        if include_optional:
    ...
    def testUpdateAPIPageData(self):
        """Test UpdateAPIPageData"""
