...
class TestGetTicketResponse1(unittest.TestCase):
    """GetTicketResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTicketResponse1:
        """Test GetTicketResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTicketResponse1`
        """
        model = GetTicketResponse1()
        if include_optional:
    ...
    def testGetTicketResponse1(self):
        """Test GetTicketResponse1"""
