...
class TestPinCommentResponse(unittest.TestCase):
    """PinCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PinCommentResponse:
        """Test PinCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PinCommentResponse`
        """
        model = PinCommentResponse()
        if include_optional:
    ...
    def testPinCommentResponse(self):
        """Test PinCommentResponse"""
