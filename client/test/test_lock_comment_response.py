...
class TestLockCommentResponse(unittest.TestCase):
    """LockCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LockCommentResponse:
        """Test LockCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LockCommentResponse`
        """
        model = LockCommentResponse()
        if include_optional:
    ...
    def testLockCommentResponse(self):
        """Test LockCommentResponse"""
