...
class TestGetBanUsersFromCommentResponse(unittest.TestCase):
    """GetBanUsersFromCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBanUsersFromCommentResponse:
        """Test GetBanUsersFromCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBanUsersFromCommentResponse`
        """
        model = GetBanUsersFromCommentResponse()
        if include_optional:
    ...
    def testGetBanUsersFromCommentResponse(self):
        """Test GetBanUsersFromCommentResponse"""
