...
class TestPendingCommentToSyncOutbound(unittest.TestCase):
    """PendingCommentToSyncOutbound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingCommentToSyncOutbound:
        """Test PendingCommentToSyncOutbound
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingCommentToSyncOutbound`
        """
        model = PendingCommentToSyncOutbound()
        if include_optional:
    ...
    def testPendingCommentToSyncOutbound(self):
        """Test PendingCommentToSyncOutbound"""
