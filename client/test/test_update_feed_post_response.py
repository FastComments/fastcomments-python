...
class TestUpdateFeedPostResponse(unittest.TestCase):
    """UpdateFeedPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFeedPostResponse:
        """Test UpdateFeedPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFeedPostResponse`
        """
        model = UpdateFeedPostResponse()
        if include_optional:
    ...
    def testUpdateFeedPostResponse(self):
        """Test UpdateFeedPostResponse"""
