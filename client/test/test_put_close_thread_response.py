...
class TestPutCloseThreadResponse(unittest.TestCase):
    """PutCloseThreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutCloseThreadResponse:
        """Test PutCloseThreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutCloseThreadResponse`
        """
        model = PutCloseThreadResponse()
        if include_optional:
    ...
    def testPutCloseThreadResponse(self):
        """Test PutCloseThreadResponse"""
