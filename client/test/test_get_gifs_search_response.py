...
class TestGetGifsSearchResponse(unittest.TestCase):
    """GetGifsSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGifsSearchResponse:
        """Test GetGifsSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGifsSearchResponse`
        """
        model = GetGifsSearchResponse()
        if include_optional:
    ...
    def testGetGifsSearchResponse(self):
        """Test GetGifsSearchResponse"""
