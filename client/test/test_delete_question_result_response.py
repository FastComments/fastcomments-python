...
class TestDeleteQuestionResultResponse(unittest.TestCase):
    """DeleteQuestionResultResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteQuestionResultResponse:
        """Test DeleteQuestionResultResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteQuestionResultResponse`
        """
        model = DeleteQuestionResultResponse()
        if include_optional:
    ...
    def testDeleteQuestionResultResponse(self):
        """Test DeleteQuestionResultResponse"""
