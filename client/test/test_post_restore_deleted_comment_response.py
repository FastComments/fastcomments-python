...
class TestPostRestoreDeletedCommentResponse(unittest.TestCase):
    """PostRestoreDeletedCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostRestoreDeletedCommentResponse:
        """Test PostRestoreDeletedCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostRestoreDeletedCommentResponse`
        """
        model = PostRestoreDeletedCommentResponse()
        if include_optional:
    ...
    def testPostRestoreDeletedCommentResponse(self):
        """Test PostRestoreDeletedCommentResponse"""
