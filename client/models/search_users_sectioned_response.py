...
class SearchUsersSectionedResponse(BaseModel):
    """
    SearchUsersSectionedResponse
    """ # noqa: E501
    status: APIStatus
    sections: List[UserSearchSectionResult]
    __properties: ClassVar[List[str]] = ["status", "sections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sections": [UserSearchSectionResult.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None
        })
        return _obj
