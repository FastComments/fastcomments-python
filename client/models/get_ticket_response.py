...
class GetTicketResponse(BaseModel):
    ...
    available_states: List[Union[StrictFloat, StrictInt]] = Field(alias="availableStates")
    __properties: ClassVar[List[str]] = ["status", "ticket", "availableStates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ticket": APITicketDetail.from_dict(obj["ticket"]) if obj.get("ticket") is not None else None,
            "availableStates": obj.get("availableStates")
        })
        return _obj
