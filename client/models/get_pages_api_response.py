...
class GetPagesAPIResponse(BaseModel):
    """
    GetPagesAPIResponse
    """ # noqa: E501
    reason: Optional[StrictStr] = None
    code: Optional[StrictStr] = None
    pages: Optional[List[APIPage]] = None
    status: StrictStr
    __properties: ClassVar[List[str]] = ["reason", "code", "pages", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "pages": [APIPage.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
