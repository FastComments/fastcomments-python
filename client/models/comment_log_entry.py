...
class CommentLogEntry(BaseModel):
    """
    CommentLogEntry
    """ # noqa: E501
    d: datetime
    t: CommentLogType
    da: Optional[CommentLogData] = None
    __properties: ClassVar[List[str]] = ["d", "t", "da"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "d": obj.get("d"),
            "t": obj.get("t"),
            "da": CommentLogData.from_dict(obj["da"]) if obj.get("da") is not None else None
        })
        return _obj
