...
class LiveEvent(BaseModel):
    ...
    feed_post: Optional[FeedPost] = Field(default=None, alias="feedPost")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of feed_post
        if self.feed_post:
            _dict['feedPost'] = self.feed_post.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feedPost": FeedPost.from_dict(obj["feedPost"]) if obj.get("feedPost") is not None else None,
