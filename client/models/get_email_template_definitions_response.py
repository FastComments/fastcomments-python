...
class GetEmailTemplateDefinitionsResponse(BaseModel):
    """
    GetEmailTemplateDefinitionsResponse
    """ # noqa: E501
    status: APIStatus
    definitions: List[EmailTemplateDefinition]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "definitions": [EmailTemplateDefinition.from_dict(_item) for _item in obj["definitions"]] if obj.get("definitions") is not None else None
        })
        return _obj
