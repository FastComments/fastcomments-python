...
SEARCHUSERSRESULT_ANY_OF_SCHEMAS = ["SearchUsersResponse", "SearchUsersSectionedResponse"]
...
class SearchUsersResult(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[SearchUsersResponse, SearchUsersSectionedResponse]] = None
    else:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = SearchUsersResult.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in SearchUsersResult with anyOf schemas: SearchUsersResponse, SearchUsersSectionedResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into SearchUsersResult with anyOf schemas: SearchUsersResponse, SearchUsersSectionedResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], SearchUsersResponse, SearchUsersSectionedResponse]]:
