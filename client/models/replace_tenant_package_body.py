...
class ReplaceTenantPackageBody(BaseModel):
    """
    ReplaceTenantPackageBody
    """ # noqa: E501
    name: StrictStr
    monthly_cost_usd: Union[StrictFloat, StrictInt] = Field(alias="monthlyCostUSD")
    yearly_cost_usd: Union[StrictFloat, StrictInt] = Field(alias="yearlyCostUSD")
