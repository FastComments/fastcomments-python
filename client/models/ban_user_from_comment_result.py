...
class BanUserFromCommentResult(BaseModel):
    """
    BanUserFromCommentResult
    """ # noqa: E501
    status: StrictStr
    changelog: Optional[APIBanUserChangeLog] = None
    code: Optional[StrictStr] = None
    reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "changelog", "code", "reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changelog": APIBanUserChangeLog.from_dict(obj["changelog"]) if obj.get("changelog") is not None else None,
            "code": obj.get("code"),
