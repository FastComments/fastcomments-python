...
class ModerationSuggestResponse(BaseModel):
    """
    ModerationSuggestResponse
    """ # noqa: E501
    status: StrictStr
    pages: Optional[List[ModerationPageSearchProjected]] = None
    users: Optional[List[ModerationUserSearchProjected]] = None
    code: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "pages", "users", "code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pages": [ModerationPageSearchProjected.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
            "users": [ModerationUserSearchProjected.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "code": obj.get("code")
        })
        return _obj
