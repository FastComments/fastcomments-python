...
class GetSubscriptionsAPIResponse(BaseModel):
    """
    GetSubscriptionsAPIResponse
    """ # noqa: E501
    reason: Optional[StrictStr] = None
    code: Optional[StrictStr] = None
    subscriptions: Optional[List[APIUserSubscription]] = None
    status: StrictStr
    __properties: ClassVar[List[str]] = ["reason", "code", "subscriptions", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "subscriptions": [APIUserSubscription.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None,
