...
class ModerationAPIGetLogsResponse(BaseModel):
    """
    ModerationAPIGetLogsResponse
    """ # noqa: E501
    logs: List[ModerationAPICommentLog]
    status: APIStatus
    __properties: ClassVar[List[str]] = ["logs", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [ModerationAPICommentLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
