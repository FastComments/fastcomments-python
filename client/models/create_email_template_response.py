...
class CreateEmailTemplateResponse(BaseModel):
    ...
    """ # noqa: E501
    status: APIStatus
    email_template: CustomEmailTemplate = Field(alias="emailTemplate")
    __properties: ClassVar[List[str]] = ["status", "emailTemplate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emailTemplate": CustomEmailTemplate.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None
        })
        return _obj
