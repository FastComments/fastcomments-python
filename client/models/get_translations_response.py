...
class GetTranslationsResponse(BaseModel):
    ...
    """ # noqa: E501
    translations: Dict[str, StrictStr] = Field(description="Construct a type with a set of properties K of type T")
    status: APIStatus
    __properties: ClassVar[List[str]] = ["translations", "status"]
