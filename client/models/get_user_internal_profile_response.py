...
class GetUserInternalProfileResponse(BaseModel):
    """
    GetUserInternalProfileResponse
    """ # noqa: E501
    profile: GetUserInternalProfileResponseProfile
    status: APIStatus
    __properties: ClassVar[List[str]] = ["profile", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profile": GetUserInternalProfileResponseProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
