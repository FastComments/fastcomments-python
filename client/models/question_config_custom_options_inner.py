...
class QuestionConfigCustomOptionsInner(BaseModel):
    """
    QuestionConfigCustomOptionsInner
    """ # noqa: E501
    image_src: StrictStr = Field(alias="imageSrc")
    name: StrictStr
    __properties: ClassVar[List[str]] = ["imageSrc", "name"]
