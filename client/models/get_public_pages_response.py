...
class GetPublicPagesResponse(BaseModel):
    """
    ...
    status: APIStatus
    __properties: ClassVar[List[str]] = ["nextCursor", "pages", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pages": [PublicPage.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
