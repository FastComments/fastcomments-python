...
class GetTenantManualBadgesResponse(BaseModel):
    """
    GetTenantManualBadgesResponse
    """ # noqa: E501
    badges: List[TenantBadge]
    status: APIStatus
    __properties: ClassVar[List[str]] = ["badges", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "badges": [TenantBadge.from_dict(_item) for _item in obj["badges"]] if obj.get("badges") is not None else None,
