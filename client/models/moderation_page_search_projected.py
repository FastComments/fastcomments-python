...
class ModerationPageSearchProjected(BaseModel):
    """
    ...
    url: StrictStr
    title: StrictStr
    comment_count: Union[StrictFloat, StrictInt] = Field(alias="commentCount")
    __properties: ClassVar[List[str]] = ["urlId", "url", "title", "commentCount"]
