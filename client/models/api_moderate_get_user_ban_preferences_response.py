...
class APIModerateGetUserBanPreferencesResponse(BaseModel):
    """
    APIModerateGetUserBanPreferencesResponse
    """ # noqa: E501
    preferences: Optional[APIModerateUserBanPreferences]
    status: APIStatus
    __properties: ClassVar[List[str]] = ["preferences", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "preferences": APIModerateUserBanPreferences.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None,
