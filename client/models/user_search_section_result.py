...
class UserSearchSectionResult(BaseModel):
    """
    UserSearchSectionResult
    """ # noqa: E501
    section: UserSearchSection
    users: List[UserSearchResult]
    __properties: ClassVar[List[str]] = ["section", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [UserSearchResult.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
