...
class BuildModerationFilterParams(BaseModel):
    """
    ...
    search_filters: Optional[StrictStr] = Field(default=None, alias="searchFilters")
    text_search: Optional[StrictStr] = Field(default=None, alias="textSearch")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userId", "tenantId", "filters", "searchFilters", "textSearch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchFilters": obj.get("searchFilters"),
