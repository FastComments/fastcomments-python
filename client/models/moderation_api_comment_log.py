...
class ModerationAPICommentLog(BaseModel):
    """
    ...
    message_html: StrictStr = Field(alias="messageHTML")
    __properties: ClassVar[List[str]] = ["date", "username", "actionName", "messageHTML"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messageHTML": obj.get("messageHTML")
        })
        return _obj
