...
class ModerationSiteSearchResponse(BaseModel):
    """
    ModerationSiteSearchResponse
    """ # noqa: E501
    sites: List[ModerationSiteSearchProjected]
    status: APIStatus
    __properties: ClassVar[List[str]] = ["sites", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sites": [ModerationSiteSearchProjected.from_dict(_item) for _item in obj["sites"]] if obj.get("sites") is not None else None,
