...
class GetNotificationsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "notifications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notifications": [UserNotification.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
        return _obj
