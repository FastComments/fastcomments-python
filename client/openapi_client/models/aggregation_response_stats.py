...
class AggregationResponseStats(BaseModel):
    """
    AggregationResponseStats
    """ # noqa: E501
    time_ms: Union[StrictFloat, StrictInt] = Field(alias="timeMS")
    scanned: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["timeMS", "scanned"]
