...
class BulkAggregateQuestionResultsRequest(BaseModel):
    """
    BulkAggregateQuestionResultsRequest
    """ # noqa: E501
    aggregations: List[BulkAggregateQuestionItem]
    __properties: ClassVar[List[str]] = ["aggregations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregations": [BulkAggregateQuestionItem.from_dict(_item) for _item in obj["aggregations"]] if obj.get("aggregations") is not None else None
        })
        return _obj
