...
class CreateCommentParams(BaseModel):
    ...
    local_date_hours: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="localDateHours")
    ...
    autoplay_delay_ms: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="autoplayDelayMS")
