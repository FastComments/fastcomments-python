...
class PickOmitFCommentDatePublicCommentPubSubFieldsKeys(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "urlId", "url", "pageTitle", "date", "tenantId", "userId", "anonUserId", "commenterName", "commenterLink", "comment", "commentHTML", "parentId", "votes", "votesUp", "votesDown", "expireAt", "verified", "reviewed", "avatarSrc", "isSpam", "hasImages", "hasLinks", "hasCode", "approved", "locale", "isDeleted", "isDeletedUser", "isBannedUser", "isByAdmin", "isByModerator", "isPinned", "isLocked", "flagCount", "rating", "displayLabel", "badges", "domain", "feedbackIds", "groupIds", "viewCount"]
