...
class PickFCommentPublicCommentFieldsKeys(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_id", "date", "userId", "anonUserId", "commenterName", "commenterLink", "commentHTML", "parentId", "votes", "votesUp", "votesDown", "verified", "avatarSrc", "isSpam", "hasImages", "isDeleted", "isDeletedUser", "isByAdmin", "isByModerator", "isPinned", "isLocked", "rating", "displayLabel", "badges", "feedbackIds", "viewCount", "requiresVerification", "editKey"]
