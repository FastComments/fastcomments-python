...
class HeaderState(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in notification_counts (list)
        _items = []
        if self.notification_counts:
            for _item_notification_counts in self.notification_counts:
