...
class BulkAggregateQuestionResultsResponse(BaseModel):
    """
    BulkAggregateQuestionResultsResponse
    """ # noqa: E501
    status: APIStatus
    data: Dict[str, QuestionResultAggregationOverall] = Field(description="Construct a type with a set of properties K of type T")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": dict(
                (_k, QuestionResultAggregationOverall.from_dict(_v))
